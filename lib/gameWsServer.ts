...
type OutgoingFrame =
  ...
  | { type: "guess_result"; word: string; result: string; points: number; description: string | null; inDictionary?: boolean; player_results: UpdatePayload["current_round"]["results"] }
      ...
      ws.on("message", async (data) => {
        ...
        if (frame.type === "guess") {
          ...
          send(ws, {
            ...
            inDictionary: response.inDictionary,
